...
sleep 10
docker run -itd --rm --name spring --privileged=true -p 46801:46801 -e SPRING_PROFILES_ACTIVE=docker -e DB2_HOST=192.168.0.14 apankura/java-spring-gradle-one-db2-spring
sleep 10